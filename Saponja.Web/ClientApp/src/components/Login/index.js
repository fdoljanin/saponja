      ...
      <div>
        ...
        <div className="login">
          ...
          <form className="login-container" onSubmit={handleSubmit}>
            ...
            <input placeholder="E-mail" onChange={handleChange} name="email" placeholder="E-mail"/>
            <input placeholder="Lozinka" onChange={handleChange} name="password" type="password" placeholder="Lozinka"/>
